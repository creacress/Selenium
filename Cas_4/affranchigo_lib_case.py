...
class AffranchigoFLibCase:
    ...
    def handle_liberte_case_1(self, driver):
        """
        Traite le cas où l'option "Dépôt et Traitement" est sélectionnée.
        """
        # Sélecteur pour 'Dépôt et Traitement'
        depot_traitement_selector = "#g0_p265\\|0_r2055\\[0\\] > div > critere-form:nth-child(9) > div.form-group.critere_psc > input-component > div > select"
        ...
        try:
            ...
            if depot_traitement_present:
                ...
                # Appel de l'onglet Réalisations
                
                print("Contrat Liberté Cas 1 ('Dépôt et Traitement') satisfait")
            else:
                print("Condition pour le contrat liberté cas 1 ('Dépôt et Traitement') non remplie")
                log_error_and_capture_screenshot(driver, "Liberté dépôt et traitement non présent", e)
        except NoSuchElementException as e:
            print(f"Erreur dans contrat liberté handle_case_1 ('Dépôt et Traitement') : {e}")
            log_error_and_capture_screenshot(driver, "Liberte_Case_1", e)
    
    def handle_liberte_case_2(self, driver):
        # Initialisation des variables
        traitement_present = False
        depot_present = False
        # Les sélecteurs des deux premiers 'select'
        select_1_selector = "#g0_p265\\|0_r2055\\[0\\] > div > critere-form:nth-child(3) > div.form-group.critere_psc > input-etb-prest > div > select"
        select_2_selector = "#\\[g0_p265\\|0_r2055\[0\\]\\] > div > critere-form:nth-child(3) > div.form-group.critere_psc > input-etb-prest > div > select"
        ...
        try:
            ...
            driver.save_screenshot("debug_liberte_selecteurs_cas_2.png")
            ...
            traitement_select_selector = "#g0_p265\\|0_r2055\\[0\\] > div > critere-form:nth-child(9) > div.form-group.critere_psc > input-component > div > select"
            depot_select_selector = "#\\[g0_p265\\|0_r2055\\[0\\]\\] > div > critere-form:nth-child(9) > div.form-group.critere_psc > input-component > div > select"
            ...
            if traitement_present and depot_present:
                ...
                print("Cas Liberté 1 satisfait")
            else:
                print("Conditions pour le Cas Liberté 1 non remplies")
                log_error_and_capture_screenshot(driver, "Conditions liberté cas 2 non remplies", e)

        except NoSuchElementException as e:
            print(f"Erreur cas Liberté 1 : {e}")
            log_error_and_capture_screenshot(driver, "Liberte_Case_2", e)


    def handle_liberte_case_3(self, driver):
        print("Début de handle_liberte_case_3")
         # Selecteurs Rôles
        select_1_role = "#g0_p265\\|0_r2055\\[0\\] > div > critere-form:nth-child(9) > div.form-group.critere_psc > input-component > div > select"
        select_2_role = "#\\[g0_p265\|0_r2055\[0\\]\\] > div > critere-form:nth-child(9) > div.form-group.critere_psc > input-component > div > select"
        ...
        try:
            ...
            if select_first_role.first_selected_option.text == "Dépôt" and select_second_role.first_selected_option.text == "Dépôt et Traitement":
                ...
                print("Ne conviens pas au cas Liberté 3")
            # Selectionne l'heure
            self.select_time_in_selectors()
            print("L'heure c'est bien mis a jour")
        except NoSuchElementException as e:
            print(f"Erreur Cas Liberté 3 : {e}")
            log_error_and_capture_screenshot(driver, "Liberte_Case_3", e)
